...
public class CronJobFerias : IJob
{
    ...
    public Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            MailAddress to = new MailAddress("jmonteiro@food-tech.pt");
            ...
            foreach (var f in dbContext.ObterListaFeriasValidar())
            {
