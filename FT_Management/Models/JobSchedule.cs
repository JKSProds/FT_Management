...
public class HelloWorldJob : IJob
{
    ...
    public Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            foreach (FolhaObra folha in dbContext.ObterListaFolhasObra("", DateTime.Now.ToString("yyyy-MM-dd")))
            {
                var pdf = new MemoryStream(dbContext.PreencherFormularioFolhaObra(folha).ToArray());
