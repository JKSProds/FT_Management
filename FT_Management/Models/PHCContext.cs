namespace FT_Management.Models
{
    public class PHCContext
    {
        ...
        public string ValidarFolhaObra(FolhaObra fo)
        {
            ...
            if (fo.ValorTotal > 500 && (fo.ClienteServico.IdCliente == 878 || fo.ClienteServico.IdCliente == 890 || fo.ClienteServico.IdCliente == 561 || fo.ClienteServico.IdCliente == 1560)) res += "O valor da reparação excede o valor máximo definido para esse cliente! Valor Total: " + fo.ValorTotal + "€\r\n";
