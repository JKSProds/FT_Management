...
namespace FT_Management.Models
{
    public class PHCContext
    {
        ...
        public List<Marcacao> ObterMarcacoes(DateTime DataInicio, DateTime DataFim)
        {
            ...
            return ObterMarcacoes("select * from v_marcacoes where data between '" + DataInicio.ToString("yyyyMMdd") + "' and '" + DataFim.ToString("yyyyMMdd") + "'", false, true, true, false, false, false);
        }
        public List<Marcacao> ObterMarcacoes(int IdTecnico, DateTime DataInicio, DateTime DataFim)
        {
            ...
            //return LstMarcacoes;
            return ObterMarcacoes("select * from v_marcacoes where tecnno="+IdTecnico+" data between '" + DataInicio.ToString("yyyyMMdd") + "' and '" + DataFim.ToString("yyyyMMdd") + "'", false, true, true, false, false, false);
        }
        public List<Marcacao> ObterMarcacoes(Cliente c)
        {
            ...
            return ObterMarcacoes("select * from v_marcacoes where no="+c.IdCliente+" and estab="+c.IdLoja, true, true, true, true, false, false);
        }
        ...
        public List<Marcacao> ObterMarcacoesSimples()
        {
            ...
            return ObterMarcacoes("select * from v_marcacoes WHERE estado not in ('AT Validada', 'Aguarda Ped. Compra') order by estado;", false, false, false, false, false, false);
        ...
        public List<Marcacao> ObterMarcacoes()
        {
            ...
            return ObterMarcacoes("select * from v_marcacoes", false, true, true, false, false, false);
        }
