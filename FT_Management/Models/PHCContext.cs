namespace FT_Management.Models
{
    public class PHCContext
    {
        ...
        public string ValidarFolhaObra(FolhaObra fo)
        {
            ...
            if (fo.Marcacao.DatasAdicionaisDistintas.Where(d => d.ToShortDateString() == fo.DataServico.ToShortDateString()).Count() == 0) res += "A data da intervenção ("+fo.DataServico.ToShortDateString()+") é diferente da data da marcação ("+fo.Marcacao.DataMarcacao.ToShortDateString()+")!\r\n";
