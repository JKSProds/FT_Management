...
namespace FT_Management.Models
{
    public class PHCContext
    {
        ...
        public List<Marcacao> ObterMarcacoesCriadas()
        {
            ...
            return ObterMarcacoes("select * from v_marcacoes WHERE estado='Criado' or estado='Rececionado';", false, true, true, false, false, false).OrderBy(m => m.IdMarcacao).ToList();
